  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-gray-900 pb-20">
      ...
      <header className="bg-white border-b border-gray-200 px-6 py-5 sticky top-0 z-30">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
            <div>
                ...
                <p className="text-sm text-gray-500 mt-1">Real-time overview of the Aurora platform.</p>
            </div>
            <div className="flex items-center gap-2 px-3 py-1.5 bg-green-50 border border-green-200 rounded-full animate-pulse">
                ...
                <span className="text-xs font-bold text-green-700 uppercase tracking-wide">System Operational</span>
            </div>
        </div>
      </header>
      ...
      <main className="max-w-7xl mx-auto px-6 py-10 space-y-8">
        ...
        <section>
            ...
            {loading ? (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {[1, 2, 3, 4].map(i => (
                        <div key={i} className="h-32 bg-white border border-gray-100 rounded-2xl animate-pulse shadow-sm"></div>
                    ))}
                </div>
            ) : stats ? (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        {/* Dashboard Split: Actions & Health */}
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <section className="lg:col-span-2">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <Link to="/admin/users" className="group block bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:border-indigo-300 hover:shadow-md transition-all">
                        ...
                        <p className="text-sm text-gray-500">View, edit, promote, or remove users and manage role-based access control.</p>
                    </Link>
                    ...
                    <div className="group block bg-white border border-gray-200 rounded-2xl p-6 shadow-sm opacity-60 cursor-not-allowed">
                        ...
                        <p className="text-sm text-gray-500">Manage reported quizzes and flagged study notes. (Coming Soon)</p>
                    </div>
                </div>
            </section>
